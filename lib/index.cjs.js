...
var { addDoc, collection, getFirestore } = require("firebase/firestore");
 ...
 */
var firebaseConfig = {
  apiKey: "AIzaSyAGkp6If29nT-YOIYzx5yWKePoiOfFZv0E",
  authDomain: "list-of-haimdol.firebaseapp.com",
  projectId: "list-of-haimdol",
  storageBucket: "list-of-haimdol.appspot.com",
  messagingSenderId: "429165235324",
  appId: "1:429165235324:web:920857fd114c862e1ccdf9",
  measurementId: "G-4LQ06BEB2T"
};
var app = initializeApp(firebaseConfig);
var db = getFirestore(app);
const save_data = async(data)=>{
    const db_instance = await addDoc(collection(db, "ws"), {
        w: data.toString()
    });
}
